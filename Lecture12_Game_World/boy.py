...
key_event_table = {
    (SDL_KEYDOWN, SDLK_d): DEBUG_KEY,  # d키는 디버그용 치트키
...
next_state_table = {
    DashState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, RIGHT_DOWN: DashState, LEFT_DOWN: DashState, SHIFT_UP: DashState, SHIFT_DOWN: DashState, DASH_TIMER: RunState, SPACE: DashState},
    ...
    RunState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState, SHIFT_DOWN: DashState, SHIFT_UP: DashState, SPACE: RunState},
